        ...
        <div className="space-y-6">
          ...
          <div className="card card-glow p-6 md:p-8 animate-fadeIn">
            ...
            <div className="space-y-4 text-text-secondary">
              <p className="text-lg">
                Orders are processed within <span className="text-cyan-400 font-semibold">2-3 business days</span> after payment confirmation.
              </p>

              <div className="bg-bg-elevated border border-border-subtle rounded-lg p-4">
                <p className="text-sm">
                  Shipping occurs after payment confirmation. Once your payment is verified and your order is processed, your device will be shipped using your selected shipping method.
                </p>
              </div>

...
const MoneroPaymentPage = () => {
  ...
  useEffect(() => {
    document.title = 'Monero Payment - GrapheneOS Store';
      ...
      <div className="min-h-screen bg-bg-primary py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card card-glow p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-cyan-400 mb-2 uppercase tracking-wider">Payment Error</h1>
            <p className="text-text-secondary mb-6">{error}</p>
            <div className="space-x-4">
              <button
                onClick={() => navigate('/checkout')}
                className="inline-flex items-center px-4 py-2 bg-cyan-500 text-white rounded-md hover:bg-cyan-600"
              >
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 bg-bg-muted text-text-primary rounded-md hover:bg-bg-hover"
              >
                Try Again
              </button>
            </div>
    ...
    <div className="min-h-screen bg-bg-primary py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="mt-6">
            <h1 className="text-3xl font-bold text-cyan-400 uppercase tracking-wider">Monero Payment</h1>
        ...
        {paymentStatus === 'confirmed' && (
          <div className="mb-8 bg-matrix-900/30 border border-matrix-400/50 rounded-lg p-4">
            <div className="flex items-center">
              <svg className="h-6 w-6 text-matrix-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div>
                <h3 className="font-medium text-matrix-400">Payment Confirmed!</h3>
        ...
        <div className="mt-8 card card-glow p-6">
          <h3 className="text-lg font-medium text-cyan-400 mb-4 uppercase tracking-wider">Need Help?</h3>
          <div className="grid md:grid-cols-2 gap-6 text-sm text-text-secondary">
            <div>
              <h4 className="font-medium text-text-primary mb-2">Payment Issues</h4>
            ...
            <div>
              <h4 className="font-medium text-text-primary mb-2">Contact Support</h4>
              <p className="mb-2">

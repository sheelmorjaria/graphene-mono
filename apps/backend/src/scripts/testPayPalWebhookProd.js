...
// Test PayPal webhook endpoint on production
const testPayPalWebhookProduction = async () => {
  const webhookUrl = 'https://graphene-backend.onrender.com/api/payment/paypal/webhook';

  console.log('🔔 Testing PayPal webhook endpoint on PRODUCTION...');
  ...
  console.log('\n🏁 PayPal webhook test on PRODUCTION completed!');
};

// Run the test
testPayPalWebhookProduction().catch(console.error);